...
(function() { //eslint-disable-line max-statements
	...
	*/
	SkyCube.prototype.init = function(params) {
		...
		this.controls = new THREE.PanoramaControls(this.camera, this.cssRenderer.domElement);
	...
	SkyCube.prototype.load = function(params) {
		...
		*/
		...
		textureCube = cubeTextureLoader.load(urls, params.loaded, null, params.error);
	...
	**/
		...
		return new Promise(function(resolve) {
			loader.load(params.model, function(collada) {
				...
				if(params.rotation) {
					...
					dae.lookAt(this.camera.position);
				}
	...
	SkyCube.prototype.addDomElem = function(params) {
		...
		if(params.rotation) {
			...
			cssObject.lookAt(this.camera.position);
		}
